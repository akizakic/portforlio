...
#### 주요 업무
- **Kubernetes 기반 ERP 솔루션 구축형 인프라 설치 및 운영 지원**
...
**주요 수행**
- OS(RHEL 8.10 → 9.4) 및 Kubernetes(1.28 → 1.31) 버전 업그레이드 사전 검증 및 무중단 전환 지원
...
**주요 수행**
- Ansible 기반 설치셋(Role/Task) 구조 개선을 통한 구축 자동화 및 설치 구성 표준화
- 서비스 모듈별 노드 배치 및 리소스(CPU/Memory) 할당을 통한 안정적인 운영 환경 구성
- 구축형 설치 아키텍처 표준화 및 노드별 구성 요소 일원화
- 유지보수용 신규 계정 및 권한 생성 자동화 구조 개선
- A10 사용 어플리케이션 EOL(End Of Life)에 따른 최신버전 확인 및 라이센스 정책 확인
- 고객사별 패스워드 및 dcrypt/jasypt 적용을 통한 보안 강화
...
#### 프로젝트 아카이브
- 기술 회고 블로그: [CLOUD WAVE 프로젝트 회고 - EKS 기반 쇼핑몰 인프라를 구성하며 배운 점](https://akizakic.tistory.com/12)
...
- EKS 등 AWS 인프라 기반 온라인 쇼핑몰 인프라 프로젝트 수행
